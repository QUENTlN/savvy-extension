...
class TooltipManager {
  constructor() {
    ...
    this.tooltip.className =
      "fixed invisible opacity-0 transition-opacity z-[9999] min-w-[200px] w-max max-w-xs bg-[hsl(var(--popover))] text-[hsl(var(--popover-foreground))] text-xs rounded-lg shadow-xl border border-[hsl(var(--border))] p-3 pointer-events-none";
