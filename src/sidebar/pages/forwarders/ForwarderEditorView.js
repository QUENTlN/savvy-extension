...
const CONSOLIDATION_MODES = [
  { value: 'as_is', labelKey: 'forwarders.consolidationMode.asIs', helpKey: 'forwarders.consolidationMode.asIsHelp' },
  { value: 'consolidate', labelKey: 'forwarders.consolidationMode.consolidate', helpKey: 'forwarders.consolidationMode.consolidateHelp' },
  { value: 'single', labelKey: 'forwarders.consolidationMode.single', helpKey: 'forwarders.consolidationMode.singleHelp' },
]
...
function renderFeeSection(prefix, label, feeData, forwarder, preset = 'simpleOnly') {
  ...
  const showConsolidateWarning = consolidationMode === 'consolidate' && !BIN_PACKING_TYPES.includes(reShippingType)
